...
export default function Member() {
    ...
    return (
        ...
        <div className='temp-btn-container'>
            <button onClick={handleSuccess} className='temp-button'>Submit login/reg success<br></br>Temp. Member.js</button>
            <button onClick={handleFailure} className='temp-button'>Submit login/reg failure<br></br>Temp. Member.js</button>
        </div>
