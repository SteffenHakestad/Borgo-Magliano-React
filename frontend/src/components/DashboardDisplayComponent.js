...
export default function DashboardDisplayComponent({
	onEditClick,
	FullName,
	Email,
	PhoneNumber,
		...
		<div className="dashboard-inner-container">
			<div className="dashboard-edit-exit-btn-container">
				<button className="dashboard-edit-btn" onClick={onEditClick}>
					<img
						...
						src={process.env.PUBLIC_URL + "/assets/icons/EditIcon.svg"}
						alt="Edit-Icon"
					/>
				</button>
			</div>
			<div className="profile-pic-container">
				<div className="profile-pic-frame">
					<img src={`${PathToProfilePic}`} alt="Profile-Pic" />
				</div>
			</div>
			...
			<div className="dashboard-email-container">
				<img
					className="dashboard-user-info-img"
					src={process.env.PUBLIC_URL + "/assets/icons/EmailIcon.svg"}
					alt="Email-Icon"
				/>
